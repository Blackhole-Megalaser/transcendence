...
TODO: add brief responsability descritption
...
TODO: mention the tools we use for organizing tasks

We used a google sheet to agree which project modules we would implement, and roughly track who would be working on it.

https://docs.google.com/spreadsheets/d/1-unfSmSeZFW78XxymSvcDQVJqaTeYh-l-Ek2GIyEvls/edit?gid=216360315
...
## TODO: add the other modules (yes I'm lazy, but it's my day off)
